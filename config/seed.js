...
(async function() {
  ...
  const items = await Item.create([
    {name: '80s hair metal snare', imageURL: '/img/cynbal-top.png', description: 'For when you turn 55 and join a Motley Crue tribute band', category: categories[0], price: 8000.00},
    ...
    {name: 'Trash can lid cymbal', imageURL: '/img/cymbal-top.png', description: 'Goes with Lars Ulrichs snare drum in St. Anger', category: categories[2], price: 200.00},
    {name: 'Broken crash', imageURL: '/img/broken-crash.png', description: 'Goes with Lars Ulrichs snare drum in St. Anger', category: categories[2], price: 200.00},
    {name: 'The kick drum Keith Moon filled with cherry bombs', imageURL: '/img/cynbal-top.png', description: 'Look it up. It really happened.', category: categories[3], price: 4000.00},
